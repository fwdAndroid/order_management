...
class MainAreaPage extends StatefulWidget {
  ...
  @override
  State<MainAreaPage> createState() => _MainAreaPageState();
}
            ...
            TextButton(
                onPressed: () {
                  Navigator.push(context,
                      MaterialPageRoute(builder: (builder) => AreaOrderTab()));
                },
                child: Text(
                  "History",
                  style: TextStyle(
                  ...
                  ElevatedButton(
                    onPressed: () {
                      ...
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (builder) => AreaManagerOrderPage(
                                    area: ds['area'],
                                    email: ds['email'],
                                    name: ds['name'],
                                  )));
