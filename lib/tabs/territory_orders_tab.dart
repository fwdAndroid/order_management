...
class TerritoryOrderTab extends StatefulWidget {
  const TerritoryOrderTab({super.key});

  @override
  State<TerritoryOrderTab> createState() => _TerritoryOrderTabState();
}

class _TerritoryOrderTabState extends State<TerritoryOrderTab> {
  @override
    ...
    return Scaffold(
      ...
      body: DefaultTabController(
        ...
        child: Scaffold(
          ...
          body: TabBarView(
            children: [
              TerritoryActiveOrders(
                Uuid: "",
              ),
              CompletedTerritoryOrders()
            ],
          ),
        ),
      ),
