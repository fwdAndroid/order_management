...
class ZonalLogin extends StatefulWidget {
  String zonal = "Zonal";
  ZonalLogin({Key? key, required this.zonal}) : super(key: key);

  @override
  _ZonalLoginState createState() => _ZonalLoginState();
}

class _ZonalLoginState extends State<ZonalLogin> {
